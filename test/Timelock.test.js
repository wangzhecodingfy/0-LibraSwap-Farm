...
const LibToken = artifacts.require('LibToken');
...
contract('Timelock', ([alice, bob, carol, dev, minter]) => {
    beforeEach(async () => {
        this.lib = await LibToken.new({ from: alice });
        this.timelock = await Timelock.new(bob, '28800', { from: alice }); //8hours
        console.log("Encode param:"+carol);
        console.log(encodeParameters(['address'], [carol]));
    ...
    //     console.log(encodeParameters(['address'], [carol]), eta);
    //     await expectRevert(
