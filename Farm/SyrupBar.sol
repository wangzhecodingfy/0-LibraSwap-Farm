...
contract SyrupBar is BEP20('SyrupBar Token', 'SYRUP') {
    ...
    // Safe lib transfer function, just in case if rounding error causes pool to not have enough LIBs.
    function safeLibTransfer(address _to, uint256 _amount) public onlyOwner {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying LIBs (not scaled);
