...
contract Libre is Context,Ownable,IBEP20 {
    ...
    uint256 internal _currentSupply;  // total circulation amount in the market (burned amount not included)
    ...
    uint256 internal total_reward;
    uint256 internal reward_per_block;
    ...
    constructor() public{
        ...
        balances[tx.origin] = balances[tx.origin].add(inital_supply);
        _moveDelegates(address(0), delegates[tx.origin], inital_supply);
    ...
    function mintReward() public onlyChef {
        ...
        _currentSupply = _currentSupply.add(actual_reward);
    ...
    function setChef(address chef) public onlyOwner {
        _chef = chef;
        allowances[address(this)][chef] = 2**256-1;
    }
    /**
